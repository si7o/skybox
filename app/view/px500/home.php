            ...
            <ul class="listado_panoramicas_500">
                ...
                <li>
                    <a href="/500px<?= $photo->url?>/">
                        ...
                        <img src="<?= str_replace('2.jpg','3.jpg',$photo->image_url) ?>" />
                    </a>
                    <div class="by">by <a class="user" href="/500px/user/<?=$photo->user->username?>/"><?= $photo->user->username ?></a> on <a class="flickr" href="http://www.500px.com/<?= $photo->user->username?>/" target="_blank">500px</a> </div>
                </li>
                <?endif;?>
